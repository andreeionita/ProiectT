...
if ($stmt = $con->prepare('INSERT INTO users (username, password, email, role) VALUES (?, ?, ?, ?)')) {
...
$stmt->bind_param('sssi', $_POST['username'], $password, $_POST['email'], $role);
$stmt->execute();
