...
<html>
<head>
<title>Explorez la Roumanie</title>
...
<body>
 ...
 <div><h1>Panier</h1></div> <a id="btnEmpty" href="cos.php?action=empty"><img src="empty-cart.png" alt="empty-cart" title="Empty Cart" /></a>
 </div>
<?php
...
<table cellpadding="10" cellspacing="1">
 ...
 <th style="text-align: center;"><strong>Suppression du produit</strong></th>
